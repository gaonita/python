...
for l in range(0,len(travel)):
       ...
       if d == True:
        c = str(int(c) + 10) + " " + str(l) + " hours including sleep->"
       else:
          c = str(c)+ "hours"
       print(a,"->",b,",will take: ",c,)

my_little_dictionary = { 'hej': 1, 'nej': 2, 'okej': 3 }

for key in my_little_dictionary:
    print("The key is " + key + " and the value is " + str(my_little_dictionary[key]))
